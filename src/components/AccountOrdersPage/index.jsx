...
export default class AccountOrdersPage extends Component{
  render(){
    return (
							...
							<div class="col-12 col-md-3">
								...
								<nav class="mb-10 mb-md-0">
									<div class="list-group list-group-sm list-group-strong list-group-flush-x">
										<Link className="list-group-item list-group-item-action dropright-toggle active" to="account-orders">
											Orders
										</Link>
											...
											<div class="col-12 col-lg-6">
												<div class="form-row mb-4 mb-lg-0">
													<div class="col-3">
														...
														{/* <!-- Image --> */}
														<div class="embed-responsive embed-responsive-1by1 bg-cover" style={{backgroundImage: "url(assets/img/products/product-5.jpg)"}}></div>

													</div>
													<div class="col-3">

														{/* <!-- Image --> */}
														<div class="embed-responsive embed-responsive-1by1 bg-cover" style={{backgroundImage: "url(assets/img/products/product-112.jpg)"}}></div>

													</div>
													<div class="col-3">

														{/* <!-- Image --> */}
														<div class="embed-responsive embed-responsive-1by1 bg-cover" style={{backgroundImage: "url(assets/img/products/product-7.jpg)"}}></div>
											...
											<div class="col-12 col-lg-6">
												<div class="form-row mb-4 mb-lg-0">
													<div class="col-3">
														...
														{/* <!-- Image --> */}
														<div class="embed-responsive embed-responsive-1by1 bg-cover" style={{backgroundImage: "url(assets/img/products/product-11.jpg)"}}></div>
											...
											<div class="col-12 col-lg-6">
												<div class="form-row mb-4 mb-lg-0">
													<div class="col-3">
														...
														{/* <!-- Image --> */}
														<div class="embed-responsive embed-responsive-1by1 bg-cover" style={{backgroundImage: "url(assets/img/products/product-14.jpg)"}}></div>

													</div>
													<div class="col-3">

														{/* <!-- Image --> */}
														<div class="embed-responsive embed-responsive-1by1 bg-cover" style={{backgroundImage: "url(assets/img/products/product-15.jpg)"}}></div>
