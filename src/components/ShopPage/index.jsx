		...
		this.state = {
			category:{
				...
				hoodies_and_sweats:{
					activerwear: 0,
					fashion: 0,
					big_tall_swearshits: 0,
					big_tall_fashion_hoodies: 0,
				},
				denim:{
					women_shirt: 0,
					juniors_shorts: 0,
				...
				jeans:{
					men_jeans: 0,
					men_big_tall_jeans: 0,
					surf: 0,
					men_big_tall_pants: 0,
				},
				jumper_and_cardigans:{
					sweaters_plus_size: 0,
					plus_sweaters: 0,
					petite_cardigans: 0,
					tops_tees: 0,
				},
						...
						<div class="row">
														...
														<li class="list-styled-item">
															...
															<div class="collapse" id="dressesCollapse" data-parent="#productsNav">
																<div class="py-4 pl-5">
																	...
																	<div class="custom-control custom-checkbox mb-3">
																		<input class="custom-control-input" id="dressesTwo" type="checkbox" checked />
							...
							<div class="col-12 col-md-8 col-lg-9">
								...
								<div class="flickity-page-dots-inner mb-9" data-flickity='{"pageDots": true}'>
									...
									{/* <!-- Item --> */}
									<div class="w-100">
										<div class="card bg-h-100 bg-left" style={{backgroundImage: "url(assets/img/covers/cover-24.jpg)"}}>
											<div class="row" style={{minHeight: "400px"}}>
												...
												<div class="col-12 col-md-2 col-lg-4 col-xl-6 d-none d-md-block bg-cover" style={{backgroundImage: "url(assets/img/covers/cover-16.jpg)"}}></div>
											</div>
										</div>
									</div>
									...
									{/* <!-- Item --> */}
									<div class="w-100">
										<div class="card bg-cover" style={{backgroundImage: "url(assets/img/covers/cover-29.jpg)"}}>
											<div class="row align-items-center" style={{minHeight: "400px"}}>
									...
									{/* <!-- Item --> */}
									<div class="w-100">
										<div class="card bg-cover" style={{backgroundImage: "url(assets/img/covers/cover-30.jpg)"}}>
											<div class="row align-items-center" style={{minHeight: "400px"}}>
												<div class="col-12">
